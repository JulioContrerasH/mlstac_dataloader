...
class SegmentationDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        self.train_dataset = SegmentationDataset(self.data_dir, 
                                                 split='train', 
                                                 transform=transform)
        self.val_dataset = SegmentationDataset(self.data_dir, 
                                               split='validation', 
                                               transform=transform)
        self.test_dataset = SegmentationDataset(self.data_dir, 
                                                split='test', 
                                                transform=transform)
...
if __name__ == "__main__":
    path = r'D:\GitHub\mlstac_dataloader\data' # Windows users
